...
#' @param true_cases Dataframe of true cases. First column is "Time" representing time step, second column is "Cases" representing number of true cases
...
#' @param test_labels Vector of string representing label for each experiment run in the model in the data parameter
#'
...
get_cumulative_error <- function(data, true_cases, time, geo_name, test_labels){
  ...
  # Iterate through each experiment and print error
